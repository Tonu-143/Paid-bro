...
"""%(N))                                                    
───────────────────────────────────────────────────────
 [\x1b[1;96m+%s] Nama       : MEHEDI HASAN TONU
 [\x1b[1;96m+%s] Github      : https://github.com/TONU-143
───────────────────────────────────────────────────────\n'''%(N,N,N,N))
def kontol():
    os.system("clear")
    print(f""" 
...
{P}[•]{B}----------------------------------------------------{P}[•]
{B} |
{P}[•] AUTHOR: MEHEDI HASAN TONU""")
def licensi(BD-TERMUX):#line:
  try :#line:
    os .system ('clear')
    kontol()
    print (f"""
{U}[{P}1{U}]{P} MEHEDI HASAN TONU
{U}[{P}2{U}]{P} MEHEDI HASAN TONU
{U}[{P}3{U}]{P} TONU {U}[{H}Exit{U}]{H}
""")#line:49
    OOO00O0OOO00OO00O =input (f"{H}[{P}?{H}]{P} ===> Pilih :{K} ")#line:50
    if OOO00O0OOO00OO00O in ['1','01']:#line:51
      print (f"{H}[{P}!{H}]{P} Anda Akan Diarahkan Ke Whatsapp...");time .sleep (3 );os .system ('xdg-open https://wa.me/01759916221?text=Bang+Beli+Lisensi+nya+dong.......???????');exit ()#line:52
    elif OOO00O0OOO00OO00O in ['2','02']:#line:53
      O000O000OOO000OOO =input (f"{H}[{P}?{H}]{P} Api Key :{ BD-H104155XB3802110E==}")#line:54
